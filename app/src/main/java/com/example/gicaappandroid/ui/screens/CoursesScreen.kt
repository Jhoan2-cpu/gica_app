...
fun CoursesScreen() {
    val cursos = listOf(
        "Curso de Kotlin", "Curso de Android", "Curso de UI/UX",
        "Curso de Backend", "Curso de IA", "Curso de Electrónica"
    )
    ...
    Column(
        ...
        // Lista de cursos optimizada con LazyColumn
        LazyColumn(
            modifier = Modifier
                .fillMaxWidth()
                .weight(1f), // Limita la altura del LazyColumn
            verticalArrangement = Arrangement.spacedBy(16.dp)
        ) {
            items(cursos) { curso ->
                Card(
